...
public class DragontailGreatswordRightclickedProcedure {
	public static void execute(Entity entity, ItemStack itemstack) {
			...
			_player.getCooldowns().addCooldown(itemstack, 40);
		{
			...
			if (!projectileLevel.isClientSide()) {
				Projectile _entityToSpawn = initProjectileProperties(new DragonFireball(EntityType.DRAGON_FIREBALL, projectileLevel), entity, new Vec3(5, 0, 0));
