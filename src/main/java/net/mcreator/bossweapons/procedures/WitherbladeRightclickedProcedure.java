...
public class WitherbladeRightclickedProcedure {
	public static void execute(Entity entity, ItemStack itemstack) {
			...
			_player.getCooldowns().addCooldown(itemstack, 10);
		{
			...
			if (!projectileLevel.isClientSide()) {
				Projectile _entityToSpawn = initProjectileProperties(new WitherSkull(EntityType.WITHER_SKULL, projectileLevel), entity, new Vec3(5, 0, 0));
